<template>
    <article class="pt-16 pb-16">
        <div class="m-auto mb-16" style="max-width: 60ch;" v-for="year in articlesByYear" :key="year.year">
            <div class="select-none relative h20 op-10" slide-enter style="--enter-stage: -2; --enter-step: 60ms">
                <span class="text-8em color-transparent absolute left--3rem top--2rem font-bold text-stroke-2
                    text-stroke-hex-aaa">
                    {{ year.year }}
                </span>
            </div>
